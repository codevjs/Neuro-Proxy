...
export const getAllMiddlewareAction = async () => {
    try {
        await checkAbility('read', 'StripPrefix');
...
export const createMiddlewareAction = async (name: string, data: {prefixes: string}) => {
    try {
        await checkAbility('create', 'StripPrefix');
...
export const updateMiddlewareAction = async (name: string, data: {prefixes: string}) => {
    try {
        await checkAbility('update', 'StripPrefix');
...
export const deleteMiddlewareAction = async (name: string) => {
    try {
        await checkAbility('delete', 'StripPrefix');
